...
Things we are NOT taking: the old sofa (listing it on OLX), the dining table (too heavy for the [[Budget For The Move]] once the mover quoted per-kg), and the broken cooler. Everything else rides along.

Documents go in one transparent folder: Aadhaar, PAN, school certificates, the flat agreement, and the hospital file for Papa. That folder does not leave my backpack. See [[Moving Day Checklist]] for the order of operations.
